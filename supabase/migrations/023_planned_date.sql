-- Ogen 023 — תאריך תכנון בטיימליין מאסטר (planned_date)

alter table public.ideas
  add column if not exists planned_date date;

comment on column public.ideas.planned_date is 'תאריך תכנון בטיימליין מאסטר — גרירה ליום ביצוע';
...
begin
  ...
  insert into public.ideas (
    ...
    send_to_maybe_inbox, created_by_user_id, guest_session_id,
...
-- update RPC — planned_date + מאסטר יכול לעדכן רעיונות גלויים לו
