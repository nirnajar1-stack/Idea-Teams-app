...
export function Badge({
  ...
  return (
    <span
      className={cn(
        'inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-micro font-medium tracking-wide transition-[color,background-color,box-shadow,transform] duration-300',
